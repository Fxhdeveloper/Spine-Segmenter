...
GSFillHolesFilterType::Pointer PostProcessingFilters::getPostProcessedImage(BinaryThresholdFilter::Pointer inputData)
{
...
void PostProcessingFilters::binaryClosingFilter(BinaryThresholdFilter::Pointer inputData)
{
