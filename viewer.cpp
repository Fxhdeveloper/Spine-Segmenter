...
vtkSmartPointer<vtkImageFlip> Viewer::flipImage(vtkSmartPointer<vtkImageData> inputData, int flipAxis) // flip x axis
{
...
void Viewer::show3dModel(BinaryThresholdFilter::Pointer volume1, BinaryThresholdFilter::Pointer volume2){
...
void Viewer::initMapper(vtkSmartPointer<vtkPolyDataMapper> mapper, vtkSmartPointer<vtkMarchingCubes> surface){
...
void Viewer::initActor(vtkSmartPointer<vtkActor> actor, vtkSmartPointer<vtkPolyDataMapper> mapper)
{
